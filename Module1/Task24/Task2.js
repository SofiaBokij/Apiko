...
// 1) Створити клас TodoItem із полями(властивостями): id(генерується у конструкторі за допомогою функції), name, checked(за замовчуванням false). Для поля checked 
// написати гетер та сетер (добавити валідацію: поле може приймати лише булеве значення true або false)
// 2) Створити клас TodoList із полями: id(генерується у 
// конструкторі за допомогою функції), name, items(за замовчуванням пустий масив).
...
// 4) Створити 4 екземпляри класу TodoItem, добавити їх у odoList та вивести у консоль екземпляр класу TodoList.
...
class TodoItem {
  ...
  set setChecked(checked) {
    if(typeof checked === "boolean") {
      ...
      return "Checked повинно бути true або false"
    }
  }
...
class TodoList {
  ...
  addItem(item) {
    if (item instanceof TodoItem) {
      ...
      return "Елемент повинен бути типу 'TodoItem'"
    }
  }
...
const list = new TodoList("Мої справи")

const task_1 = new TodoItem("Купити продукти")
const task_2 = new TodoItem("Прибрати")
const task_3 = new TodoItem("Почитати")
const task_4 = new TodoItem("Зробити дз")
